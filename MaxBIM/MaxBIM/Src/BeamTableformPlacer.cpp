...
static short			layerInd_TimberRail;		// 레이어 번호: 블루목심
...
// 1차 배치 설정
void	BeamTableformPlacingZone::firstPlacingSettings (BeamTableformPlacingZone* placingZone)
{
	short			xx, yy;
...
void	BeamTableformPlacingZone::addNewColFromBeginAtSide (BeamTableformPlacingZone* target_zone)
{
	short xx;
...
// 측면 시작 부분 - 마지막 열을 삭제함
void	BeamTableformPlacingZone::delLastColFromBeginAtSide (BeamTableformPlacingZone* target_zone)
{
	target_zone->nCellsFromBeginAtSide --;
}

// 측면 끝 부분 - 새로운 열을 추가함 (열 하나를 늘리고 추가된 열에 마지막 열 정보 복사)
void	BeamTableformPlacingZone::addNewColFromEndAtSide (BeamTableformPlacingZone* target_zone)
{
	short xx;
...
// 측면 끝 부분 - 마지막 열을 삭제함
void	BeamTableformPlacingZone::delLastColFromEndAtSide (BeamTableformPlacingZone* target_zone)
{
	target_zone->nCellsFromEndAtSide --;
}

// 하부 시작 부분 - 새로운 열을 추가함 (열 하나를 늘리고 추가된 열에 마지막 열 정보 복사)
void	BeamTableformPlacingZone::addNewColFromBeginAtBottom (BeamTableformPlacingZone* target_zone)
{
	short xx;
...
// 하부 시작 부분 - 마지막 열을 삭제함
void	BeamTableformPlacingZone::delLastColFromBeginAtBottom (BeamTableformPlacingZone* target_zone)
{
	target_zone->nCellsFromBeginAtBottom --;
}

// 하부 끝 부분 - 새로운 열을 추가함 (열 하나를 늘리고 추가된 열에 마지막 열 정보 복사)
void	BeamTableformPlacingZone::addNewColFromEndAtBottom (BeamTableformPlacingZone* target_zone)
{
	short xx;
...
// 하부 끝 부분 - 마지막 열을 삭제함
void	BeamTableformPlacingZone::delLastColFromEndAtBottom (BeamTableformPlacingZone* target_zone)
{
	target_zone->nCellsFromEndAtBottom --;
}
...
// 유로폼/휠러/목재를 채운 후 자투리 공간 채우기 (나머지 합판/목재 및 아웃코너앵글 + 비계파이프, 각파이프행거, 유로폼 후크, 블루목심)
...
short DGCALLBACK beamTableformPlacerHandler1 (short message, short dialogID, short item, DGUserData /* userData */, DGMessageData /* msgData */)
{
	...
	switch (message) {
		case DG_MSG_INIT:
			...
			DGSetItemText (dialogID, LABEL_LAYER_TIMBER_RAIL, "블루목심");
			...
			ucb.itemID	 = USERCONTROL_LAYER_TIMBER_RAIL;
			ACAPI_Interface (APIIo_SetUserControlCallbackID, &ucb, NULL);
			DGSetItemValLong (dialogID, USERCONTROL_LAYER_TIMBER_RAIL, 1);
			...
			if (DGGetItemValLong (dialogID, CHECKBOX_LAYER_COUPLING) == 1) {
				switch (item) {
					case USERCONTROL_LAYER_EUROFORM:
						...
						DGSetItemValLong (dialogID, USERCONTROL_LAYER_TIMBER_RAIL, DGGetItemValLong (dialogID, USERCONTROL_LAYER_EUROFORM));
						break;
					case USERCONTROL_LAYER_PLYWOOD:
						...
						DGSetItemValLong (dialogID, USERCONTROL_LAYER_TIMBER_RAIL, DGGetItemValLong (dialogID, USERCONTROL_LAYER_PLYWOOD));
						break;
					case USERCONTROL_LAYER_WOOD:
						...
						DGSetItemValLong (dialogID, USERCONTROL_LAYER_TIMBER_RAIL, DGGetItemValLong (dialogID, USERCONTROL_LAYER_WOOD));
						break;
					case USERCONTROL_LAYER_OUTCORNER_ANGLE:
						...
						DGSetItemValLong (dialogID, USERCONTROL_LAYER_TIMBER_RAIL, DGGetItemValLong (dialogID, USERCONTROL_LAYER_OUTCORNER_ANGLE));
						break;
					case USERCONTROL_LAYER_FILLERSPACER:
						...
						DGSetItemValLong (dialogID, USERCONTROL_LAYER_RECTPIPE, DGGetItemValLong (dialogID, USERCONTROL_LAYER_FILLERSPACER));
						DGSetItemValLong (dialogID, USERCONTROL_LAYER_RECTPIPE_HANGER, DGGetItemValLong (dialogID, USERCONTROL_LAYER_FILLERSPACER));
						DGSetItemValLong (dialogID, USERCONTROL_LAYER_EUROFORM_HOOK, DGGetItemValLong (dialogID, USERCONTROL_LAYER_FILLERSPACER));
						DGSetItemValLong (dialogID, USERCONTROL_LAYER_TIMBER_RAIL, DGGetItemValLong (dialogID, USERCONTROL_LAYER_FILLERSPACER));
						break;
					case USERCONTROL_LAYER_RECTPIPE:
						...
						DGSetItemValLong (dialogID, USERCONTROL_LAYER_FILLERSPACER, DGGetItemValLong (dialogID, USERCONTROL_LAYER_RECTPIPE));
						...
						DGSetItemValLong (dialogID, USERCONTROL_LAYER_TIMBER_RAIL, DGGetItemValLong (dialogID, USERCONTROL_LAYER_RECTPIPE));
						break;
					case USERCONTROL_LAYER_RECTPIPE_HANGER:
						...
						DGSetItemValLong (dialogID, USERCONTROL_LAYER_FILLERSPACER, DGGetItemValLong (dialogID, USERCONTROL_LAYER_RECTPIPE_HANGER));
						...
						DGSetItemValLong (dialogID, USERCONTROL_LAYER_TIMBER_RAIL, DGGetItemValLong (dialogID, USERCONTROL_LAYER_RECTPIPE_HANGER));
						break;
					case USERCONTROL_LAYER_EUROFORM_HOOK:
						...
						DGSetItemValLong (dialogID, USERCONTROL_LAYER_FILLERSPACER, DGGetItemValLong (dialogID, USERCONTROL_LAYER_EUROFORM_HOOK));
						...
						DGSetItemValLong (dialogID, USERCONTROL_LAYER_TIMBER_RAIL, DGGetItemValLong (dialogID, USERCONTROL_LAYER_EUROFORM_HOOK));
						break;
					case USERCONTROL_LAYER_TIMBER_RAIL:
						DGSetItemValLong (dialogID, USERCONTROL_LAYER_EUROFORM, DGGetItemValLong (dialogID, USERCONTROL_LAYER_TIMBER_RAIL));
						DGSetItemValLong (dialogID, USERCONTROL_LAYER_PLYWOOD, DGGetItemValLong (dialogID, USERCONTROL_LAYER_TIMBER_RAIL));
						DGSetItemValLong (dialogID, USERCONTROL_LAYER_WOOD, DGGetItemValLong (dialogID, USERCONTROL_LAYER_TIMBER_RAIL));
						DGSetItemValLong (dialogID, USERCONTROL_LAYER_OUTCORNER_ANGLE, DGGetItemValLong (dialogID, USERCONTROL_LAYER_TIMBER_RAIL));
						DGSetItemValLong (dialogID, USERCONTROL_LAYER_FILLERSPACER, DGGetItemValLong (dialogID, USERCONTROL_LAYER_TIMBER_RAIL));
						DGSetItemValLong (dialogID, USERCONTROL_LAYER_RECTPIPE, DGGetItemValLong (dialogID, USERCONTROL_LAYER_TIMBER_RAIL));
						DGSetItemValLong (dialogID, USERCONTROL_LAYER_RECTPIPE_HANGER, DGGetItemValLong (dialogID, USERCONTROL_LAYER_TIMBER_RAIL));
						DGSetItemValLong (dialogID, USERCONTROL_LAYER_EUROFORM_HOOK, DGGetItemValLong (dialogID, USERCONTROL_LAYER_TIMBER_RAIL));
						//DGSetItemValLong (dialogID, USERCONTROL_LAYER_TIMBER_RAIL, DGGetItemValLong (dialogID, USERCONTROL_LAYER_TIMBER_RAIL));
						break;
				}
			}
			break;
