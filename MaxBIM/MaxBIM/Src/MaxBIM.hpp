...
enum	idxItem_3 {
	...
	//////////////////////////////////////// 예전 셀 설정
	// 객체 타입
	LABEL_OBJ_TYPE_PREV							= 22,
	POPUP_OBJ_TYPE_PREV							= 23,

	// 인코너, 휠러스페이서, 합판의 경우
	LABEL_WIDTH_PREV							= 24,
	EDITCONTROL_WIDTH_PREV						= 25,
	LABEL_HEIGHT_PREV							= 26,
	EDITCONTROL_HEIGHT_PREV						= 27,
	LABEL_ORIENTATION_PREV						= 28,
	RADIO_ORIENTATION_1_PLYWOOD_PREV			= 29,
	RADIO_ORIENTATION_2_PLYWOOD_PREV			= 30,

	// 유로폼의 경우
	CHECKBOX_SET_STANDARD_PREV					= 31,
	LABEL_EUROFORM_WIDTH_OPTIONS_PREV			= 32,
	POPUP_EUROFORM_WIDTH_OPTIONS_PREV			= 33,
	EDITCONTROL_EUROFORM_WIDTH_OPTIONS_PREV		= 34,
	LABEL_EUROFORM_HEIGHT_OPTIONS_PREV			= 35,
	POPUP_EUROFORM_HEIGHT_OPTIONS_PREV			= 36,
	EDITCONTROL_EUROFORM_HEIGHT_OPTIONS_PREV	= 37,
	LABEL_EUROFORM_ORIENTATION_OPTIONS_PREV		= 38,
	RADIO_ORIENTATION_1_EUROFORM_PREV			= 39,
	RADIO_ORIENTATION_2_EUROFORM_PREV			= 40,

	//////////////////////////////////////// 다음 셀 설정
	// 객체 타입
	LABEL_OBJ_TYPE_NEXT							= 41,
	POPUP_OBJ_TYPE_NEXT							= 42,

	// 인코너, 휠러스페이서, 합판의 경우
	LABEL_WIDTH_NEXT							= 43,
	EDITCONTROL_WIDTH_NEXT						= 44,
	LABEL_HEIGHT_NEXT							= 45,
	EDITCONTROL_HEIGHT_NEXT						= 46,
	LABEL_ORIENTATION_NEXT						= 47,
	RADIO_ORIENTATION_1_PLYWOOD_NEXT			= 48,
	RADIO_ORIENTATION_2_PLYWOOD_NEXT			= 49,

	// 유로폼의 경우
	CHECKBOX_SET_STANDARD_NEXT					= 50,
	LABEL_EUROFORM_WIDTH_OPTIONS_NEXT			= 51,
	POPUP_EUROFORM_WIDTH_OPTIONS_NEXT			= 52,
	EDITCONTROL_EUROFORM_WIDTH_OPTIONS_NEXT		= 53,
	LABEL_EUROFORM_HEIGHT_OPTIONS_NEXT			= 54,
	POPUP_EUROFORM_HEIGHT_OPTIONS_NEXT			= 55,
	EDITCONTROL_EUROFORM_HEIGHT_OPTIONS_NEXT	= 56,
	LABEL_EUROFORM_ORIENTATION_OPTIONS_NEXT		= 57,
	RADIO_ORIENTATION_1_EUROFORM_NEXT			= 58,
	RADIO_ORIENTATION_2_EUROFORM_NEXT			= 59
};
